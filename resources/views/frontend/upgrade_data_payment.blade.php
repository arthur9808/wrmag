        ...
        <div class="row signnn">
            <div class="col-xl-6 col-lg-6 col-sm-12 col-xs-12 left_sec">
                <div class=" left_div">
                    ...
                    <p>At the Quarterback Magazine our members are our family and we want our
                        family to succeed. We want our family to utilize our platforms to get the maximum exposure possible
                        leading to college recruitment.
                        We’re
                    ...
                    <p class="left_message">Once you complete your payment, our team will reach out to you via e-mail. Thank
                        you!</p>
                    <h4>EMAIL US</h4>
                    <h5><a clas="tel_payment" href="mailto:catch@wrmag.com">catch@wrmag.com</a>
                    </h5>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-sm-12 col-xs-12">
                                                <div class='form-group required'>
                                                    <input class='form-control' id="inputemail" name="email"
                                                        type='email' placeholder="Email" value="{{ $profile->qb_email }}" required disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='row standard'>
