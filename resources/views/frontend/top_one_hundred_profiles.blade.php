...
@section('content')
    ...
    <section id="section_red" class="section_red_bg1">
        <div class="container">
            <div class="row mb-4">
                <div class="col-12">
                    <h3>TOP 100 QUARTERBACKS</h3>
                </div>
            </div>

            <div class="row different_profiles mt-4" style="align-content: center" id="profiles_desktop">
                    ...
                    <div class="col-xl-3 col-lg-4 col-xs-12 mb-4 card-content" data-id="{{ $profile->id }}">
                        <div class="featured-qb" onclick="window.location.href='{{ url('/profile/' . $profile->slug) }}'">
                            ...
                            <a href="{{ url('/profile/' . $profile->slug) }}">
                                @if ($profile->profile_photo)
                                    <img src="{{ asset('storage/' . $profile->profile_photo) }}" style="visibility: hidden">
                                @else
...
@section('css')
    <style>
        ...
        #section_red>div>div:nth-child(3)>div {
            display: flex;
            flex-direction: row;
            justify-content: center;
            align-items: center;
