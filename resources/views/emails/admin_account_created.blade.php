														...
														<tr>
															<td style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" style="line-height:10px"><img
																		class="big" src="{{ asset('template/assets/img/email/Top.png') }}"
												...
												<td class="column column-1"
														...
														<tr>
															<td
																...
																<div align="center" style="line-height:10px"><img
																		alt="reset-password"
																		@if($is_free)
																		src="{{ asset('template/assets/img/reset-password-blue.png') }}"
																		@else
																		src="{{ asset('template/assets/img/reset-password.png') }}"
																		@endif
																	...
																	<div
																		...
																		<p
																			...
																			<span style="font-size:14px;"><span
																					style=""><b>Name:</b> {{ $f_name . ' ' . $l_name }}
																				</span><br><span style=""><b>Username:</b> {{ $username }} </span></span>
                                                                                <br><span style=""><b>Email:</b> {{ $email }} </span></span>
                                                                                <br><span style=""><b>Membership:</b> {{ $membership }} </span></span>
                                                                                <br><span style=""><b>Price:</b> {{ $price }} </span></span>
																		</p>
																	</div>
																</div>
															</td>
													...
													<table border="0" cellpadding="15" cellspacing="0"
														...
														<tr>
															<td>
																<div align="center">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.yourwebsite.com" style="height:58px;width:272px;v-text-anchor:middle;" arcsize="35%" strokeweight="0.75pt" strokecolor="#ff0000" fillcolor="#ff0000"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:18px"><![endif]--><a
																		href="{{ url('/home') }}"
																		style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#ff0000;border-radius:20px;width:auto;border-top:1px solid #ff0000;border-right:1px solid #ff0000;border-bottom:1px solid #ff0000;border-left:1px solid #ff0000;padding-top:10px;padding-bottom:10px;font-family:Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
																		target="_blank"><span
																			style="padding-left:50px;padding-right:50px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
																				style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
																					...
																					style="font-size: 18px; line-height: 36px;"><strong>ADMIN PANEL
												...
												<td class="column column-1"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" style="line-height:10px"><img
																		class="big" src="{{ asset('template/assets/img/email/Btm.png') }}"
																		style="display: block; height: auto; border: 0; width: 500px; max-width: 100%;"
																		width="500" /></div>
															</td>
														</tr>
																...
																<table align="center" border="0" cellpadding="0"
																	...
																	<tr>
																		<td style="padding:0 5px 0 5px;"><a
																				href="https:gi//www.facebook.com/"
																				target="_blank"><img alt="Facebook"
																					height="32"
																					src="{{ asset('template/assets/img/email/facebook2x.png') }}"
																		...
																		<td style="padding:0 5px 0 5px;"><a
																				...
																				target="_blank"><img alt="Twitter"
																					height="32"
																					src="{{ asset('template/assets/img/email/twitter2x.png') }}"
																					style="display: block; height: auto; border: 0;"
																		...
																		<td style="padding:0 5px 0 5px;"><a
																				...
																				target="_blank"><img alt="Instagram"
																					height="32"
																					src="{{ asset('template/assets/img/email/instagram2x.png') }}"
																					style="display: block; height: auto; border: 0;"
																		...
																		<td style="padding:0 5px 0 5px;"><a
																				...
																				target="_blank"><img alt="LinkedIn"
																					height="32"
																					src="{{ asset('template/assets/img/email/linkedin2x.png') }}"
																					style="display: block; height: auto; border: 0;"
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td>
																<div style="font-family: Tahoma, Verdana, sans-serif">
																	<div
																		style="font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #C0C0C0; line-height: 1.2;">
