            ...
            <tr>
              ...
              >
                <h1 style="text-align: center">
                  <strong>Upgrade your membership</strong>
                </h1>
                <br>
                ...
                <br>
                <p style="line-height: 1.2">
                    Your subscription has expired! Please upgrade your payment data.
                </p>
                <br>
                <p style="line-height: 1.2; text-align:center;">
                  <a style="color:#1967d2"  href="{{ url('/upgrade-data-payment/' . $id) }}">CLICK HERE FOR UPDATE YOUR PAYMENT DATA</a>
                </p>
                <br>
